...
export function DashboardCard01({ metrics }) {
...
// Card 02 - NPS Score
export function DashboardCard02({ metrics }) {
...
export function DashboardCard03({ metrics }) {
...
export function DashboardCard04({ metrics }) {
...
export function DashboardCard05({ metrics }) {
  const timeSeries = metrics.volume?.timeSeries || [];
  let runningSum = 0;
...
export function DashboardCard06({ metrics }) {
...
export function DashboardCard07({ metrics }) {
  const scores = metrics.scores?.scores || [];
...
export function DashboardCard08({ metrics }) {
...
export function DashboardCard09({ metrics }) {
...
export function DashboardCard10({ metrics }) {
...
export function DashboardCard11({ metrics }) {
...
export function DashboardCard12({ metrics }) {
  const rows = metrics.submissions?.rows?.slice(0, 5) || [];
...
export function DashboardCard13({ metrics }) {
